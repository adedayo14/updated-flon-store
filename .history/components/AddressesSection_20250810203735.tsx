  ...
  return (
    <div className="space-y-12 md:mt-12">
      <div className="border-outline relative rounded-xl border bg-background-primary p-6">
        ...
        <div className="text-md text-teal-600 font-medium">{address.name}</div>
        <div className="text-md text-teal-700">{address.address1}</div>
        {address.address2 && (
          <div className="text-md text-teal-700">{address.address2}</div>
        )}
        <div className="text-md text-teal-700">
          {address.city}, {address.state} {address.zip}
        </div>
        <div className="text-md text-teal-700">{address.country}</div>
        {address.phone && (
          <div className="text-md text-teal-700">Phone: {address.phone}</div>
        )}
        {address.company && (
          <div className="text-md text-teal-700">Company: {address.company}</div>
        )}
