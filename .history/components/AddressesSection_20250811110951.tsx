        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Default badge - inline with name for better visual hierarchy */}
              {address.default && (
                <span 
                  className="inline-flex items-center bg-green-100 text-green-800 rounded-full px-3 py-1 text-sm font-medium shadow-sm border border-green-200"
