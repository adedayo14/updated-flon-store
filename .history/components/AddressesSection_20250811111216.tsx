    ...
    <div className="space-y-6 md:mt-12">
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          {address.default && (
            <span 
              className="inline-flex items-center rounded-full px-3 py-1.5 text-sm font-medium shadow-sm border"
              style={{
                backgroundColor: 'rgb(220 252 231)', // light green background
                color: 'rgb(22 163 74)', // green text
                borderColor: 'rgb(187 247 208)' // light green border
              }}
