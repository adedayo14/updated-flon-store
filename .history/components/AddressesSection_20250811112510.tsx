    ...
    <div className="space-y-6 md:mt-12">
      <div 
        className={`relative rounded-xl border p-6 transition-all duration-200 ${
          address.default 
            ? 'border-success-dark/30 bg-success-light ring-1 ring-success-dark/20' 
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          {address.default && (
            <span 
              className="inline-flex items-center rounded-full px-3 py-1.5 text-sm font-medium shadow-sm border bg-success-light text-success-dark border-success-dark/30"
