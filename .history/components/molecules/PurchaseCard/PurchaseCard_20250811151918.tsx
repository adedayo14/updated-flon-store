  ...
  return (
    <div className="border-outline rounded-xl border bg-background-primary p-6">
      <div className="md:flex md:justify-between md:items-start">
        ...
        {/* Right side: Status at the top - HIDDEN FOR TESTING */}
        <div className="mt-6 md:mt-0 flex justify-end" style={{display: 'none'}}>
          <StatusIndicator status={status} type={props.type} />
        </div>
      </div>
      
      {/* Images positioned at the far right, below status */}
