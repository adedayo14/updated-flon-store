  ...
  return (
    <div className="border-outline rounded-xl border bg-background-primary p-6">
      <div className="md:flex md:justify-between md:items-start">
        ...
        {/* Right side: Status and images in same container */}
        <div className="mt-6 md:mt-0 md:ml-6">
          ...
          {/* Images at the absolute right edge with small padding */}
          <div className="grid grid-cols-3 gap-2 ml-auto w-fit pr-1">
