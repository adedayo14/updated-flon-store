...
const RelatedProducts: React.FC<RelatedProductsProps> = ({ 
  ...
  const getRelatedProductQuery = useCallback(() => {
    ...
    // Default fallback to get some products
    return 'eco sustainable';
  }, [cartItems]);
          ...
          <div key={product.id} className="rounded-2xl border border-solid border-outline px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex-shrink-0 w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center hover:bg-green-600 transition-colors border-2 border-green-400 shadow-sm font-bold text-lg"
