  ...
  return (
    <div id="customer-reviews" className="py-8 pr-6 lg:pr-10">
      <div className="mb-6">
        ...
        {/* Debug: Show eligibility data */}
        {eligibility && (
          <div className="bg-gray-100 p-2 mb-4 text-xs rounded">
            Debug: loggedIn: {String(eligibility.loggedIn)}, hasPurchased: {String(eligibility.hasPurchased)}, canReview: {String(eligibility.canReview)}
          </div>
        )}
