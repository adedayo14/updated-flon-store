  ...
  return (
    <div id="customer-reviews" className="w-full bg-white">
      ...
      <style jsx>{`
        ...
        .dropdown-custom option:last-child {
      ...
      <div className="px-4 sm:px-8 lg:px-16 mb-8">
        <div className="flex flex-wrap gap-4 items-center">
          ...
          {/* Rating Filter */}
          <select
            className="px-6 py-2 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-white min-w-44 dropdown-custom"
            value={ratingFilter}
