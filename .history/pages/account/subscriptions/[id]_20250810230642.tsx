  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8">
        <h2 className="text-lg font-semibold text-teal-600 mb-4 tracking-tight">Invoice breakdown</h2>
        <div className="space-y-3">
          {subscription.summaryRows.map((row, index) => (
            <div key={index} className="flex justify-between items-center py-3 border-b border-gray-100">
              <div className="text-sm text-teal-600">{row.label}</div>
              <div className="text-sm font-medium text-teal-600">{row.value}</div>
            </div>
          ))}
          <div className="flex justify-between items-center pt-4 border-t border-gray-200">
            <div className="text-sm font-semibold text-teal-600">{subscription.totalRow.label}</div>
            <div className="text-sm font-semibold text-teal-600">{subscription.totalRow.value}</div>
          </div>
        </div>
      </div>
