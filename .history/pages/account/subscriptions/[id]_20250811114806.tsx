      ...
      {status === SUBSCRIPTION_STATUS.CANCELED ? (
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-10 text-center mb-8">
          ...
          <p className={`text-sm mb-6 ${styles.tealText}`}>
            This subscription was cancelled on {(subscription as any).dateCanceled ? formatDateToLocale((subscription as any).dateCanceled, locale) : formatDateToLocale(new Date().toISOString(), locale)} and can&apos;t be restarted.
          </p>
