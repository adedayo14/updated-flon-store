...
// Define the Review interface locally
...
// Direct function to read all reviews from JSON file
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  try {
    ...
    const productNameMap = await getProductNameMapping();
    const productNames = Object.fromEntries(productNameMap);
