...
export const getServerSideProps: GetServerSideProps = async (context) => {
  try {
    ...
    // Get product names using Swell Node SDK
    ...
    try {
      ...
      for (const productId of uniqueProductIds) {
        ...
        try {
          const product = await swell.products.get(productIdStr);
      ...
      console.error('❌ Error initializing Swell or fetching product names:', error);
    }
