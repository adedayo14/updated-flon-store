  ...
  try {
    ...
    try {
      ...
      for (const productId of uniqueProductIds) {
        ...
        try {
          // Use the Swell REST API directly with the secret key for server-side calls
          const response = await fetch(`${process.env.NEXT_PUBLIC_SWELL_STORE_URL}/api/products/${productIdStr}`, {
            headers: {
