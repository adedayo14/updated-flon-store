...
export const getServerSideProps: GetServerSideProps = async (context) => {
  try {
    ...
    try {
      ...
      // For now, just use the product ID as the name until API access is sorted
      for (const productId of uniqueProductIds) {
        const productIdStr = String(productId);
        productNames[productIdStr] = `Product ${productIdStr}`;
      }
      
      console.log('Product names set from IDs:', productNames);
    } catch (error) {
