                  ...
                  <div className="flex items-start justify-between">
                    ...
                    {review.status === 'pending' && (
                      <div className="flex space-x-2 ml-6">
                        <button
                          className={`font-bold py-2 px-4 rounded shadow-md disabled:opacity-50 disabled:cursor-not-allowed border-0 ${
                            loading[review.id] 
                              ? '!bg-gray-400 !text-white cursor-not-allowed' 
                              : '!bg-green-600 hover:!bg-green-700 active:!bg-green-800 !text-white'
                          }`}
                          style={{
                            backgroundColor: loading[review.id] ? '#9ca3af' : '#16a34a',
                            color: 'white'
                          }}
                        ...
                        <button
                          ...
                          style={{
                            backgroundColor: loading[review.id] ? '#9ca3af' : '#dc2626',
                            color: 'white'
                          }}
