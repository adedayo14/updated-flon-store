                  ...
                  <div className="flex items-start justify-between">
                    ...
                    {review.status === 'pending' && (
                      <div className="flex space-x-2 ml-6">
                        <button
                          className={`font-bold py-2 px-4 rounded shadow-md disabled:opacity-50 disabled:cursor-not-allowed border-0 transition-colors approve-btn ${
                            loading[review.id] 
                        ...
                        <button
                          className={`font-bold py-2 px-4 rounded shadow-md disabled:opacity-50 disabled:cursor-not-allowed border-0 transition-colors reject-btn ${
                            loading[review.id] 
                              ? '!bg-gray-400 !text-white cursor-not-allowed' 
