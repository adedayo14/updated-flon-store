...
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'admin123'; // Set this in your .env.local
...
export default async function handler(
  ...
  // Store token hash in memory (in production, use Redis or database)
  process.env.ADMIN_TOKEN_HASH = token;
