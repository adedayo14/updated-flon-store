...
import SmartReviewSection from 'components/molecules/SmartReviewSection';
...
const ProductsPage: React.FC<ProductsPageProps> = ({
  ...
  const formatPrice = useCurrency((s: any) => s.formatPrice);
  ...
  return (
    <div>
      ...
      <article className="flex flex-col lg:grid lg:grid-cols-2">
        ...
        <aside className="mt-10 lg:px-14">
          <div className="px-6">
            <ProductHeader
              {...details}
              belowTitle={<ReviewSummary productId={productId} />}
            />
      ...
      <section className="w-full">
        <SmartReviewSection productId={productId} productName={details.title} />
      </section>
    </div>
  );
};
