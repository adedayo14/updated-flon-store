import { getProductsByIds, getProductNameById } from './lib/services/products.js';
...
async function testDirectAPI() {
  ...
  console.log('SWELL_STORE_ID:', process.env.SWELL_STORE_ID);
  console.log('NEXT_PUBLIC_SWELL_STORE_ID:', process.env.NEXT_PUBLIC_SWELL_STORE_ID);
  console.log('SWELL_SECRET_KEY:', process.env.SWELL_SECRET_KEY ? '✅ Set' : '❌ Not set');
  console.log('');
